    ...
    >
          ...
          {isAssistant && isStreaming ? (
            ...
            <Avatar size="lg">
              ...
              <AvatarFallback
                className={cn(
                  isAssistant &&
                    "rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 text-white",
                )}
              >
                {isUser ? (
                  ...
                  >
                    ...
                    <defs>
                      <radialGradient
                        id="paint0_radial_60_878"
                        cx="0"
                        cy="0"
                        r="1"
                        gradientUnits="userSpaceOnUse"
                        gradientTransform="translate(0.5 24.5) rotate(-45) scale(33.9411)"
                      >
      ...
      >
        <div
          className={cn(
            isUser &&
              "bg-secondary/50 text-foreground rounded-2xl px-4 py-3 border border-border",
