...
export type ActivityAtom = Database['public']['Tables']['activity_atoms']['Row']
...
export type InsightSource = Database['public']['Tables']['insight_sources']['Row']
export type IntegrationAuditLog = Database['public']['Tables']['integration_audit_logs']['Row']
...
export type PendingCalendarSync = Database['public']['Tables']['pending_calendar_syncs']['Row']
...
export type ActivityAtomInsert = Database['public']['Tables']['activity_atoms']['Insert']
export type AskMessageInsert = Database['public']['Tables']['ask_messages']['Insert']
export type AskThreadInsert = Database['public']['Tables']['ask_threads']['Insert']
export type CalendarWatchInsert = Database['public']['Tables']['calendar_watches']['Insert']
export type DailyEventInsert = Database['public']['Tables']['daily_events']['Insert']
...
export type InsightSourceInsert = Database['public']['Tables']['insight_sources']['Insert']
export type IntegrationAuditLogInsert = Database['public']['Tables']['integration_audit_logs']['Insert']
...
export type PendingCalendarSyncInsert = Database['public']['Tables']['pending_calendar_syncs']['Insert']
export type TaskInsert = Database['public']['Tables']['tasks']['Insert']
export type UserSignalInsert = Database['public']['Tables']['user_signals']['Insert']
...
export type ActivityAtomUpdate = Database['public']['Tables']['activity_atoms']['Update']
export type AskMessageUpdate = Database['public']['Tables']['ask_messages']['Update']
export type AskThreadUpdate = Database['public']['Tables']['ask_threads']['Update']
export type CalendarWatchUpdate = Database['public']['Tables']['calendar_watches']['Update']
export type DailyEventUpdate = Database['public']['Tables']['daily_events']['Update']
...
export type InsightSourceUpdate = Database['public']['Tables']['insight_sources']['Update']
export type IntegrationAuditLogUpdate = Database['public']['Tables']['integration_audit_logs']['Update']
...
export type PendingCalendarSyncUpdate = Database['public']['Tables']['pending_calendar_syncs']['Update']
export type TaskUpdate = Database['public']['Tables']['tasks']['Update']
export type UserSignalUpdate = Database['public']['Tables']['user_signals']['Update']
...
export type IntegrationSyncStatus = NonNullable<Integration['last_sync_status']>
